...
public class Juego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(83, 105, 98));
    ...
    private void panelImage1KeyPressed(java.awt.event.KeyEvent evt) {
    ...
    private void save_puntaje(){
        String puntaje = jPuntaje.getText();
        PuntajesDAO punt = new PuntajesDAO();
        punt.guardarPuntaje(nombre, Integer.valueOf(puntaje));
    }
    ...
    public void mostrarPuntaje() {
        ...
        panel2.setBackground(new Color(83, 105, 98));
    ...
    private void mostrarLogin() {
        ...
        panel1.setBackground(new Color(83, 105, 98));
